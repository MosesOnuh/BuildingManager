...
namespace BuildingManager.Contracts.Services
{
    public interface IActivityService
    {
        ...
        Task<SuccessResponse<ActivityDto>> DeleteActivityFile(string projId, string activityId, string userId);
        Task<GetObjectResponse> DownloadActivityFileOtherPro(DownloadActivityFileDto model, string userId);
        Task<GetObjectResponse> DownloadActivityFilePM(DownloadActivityFileDto model);
