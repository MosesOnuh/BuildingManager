...
namespace BuildingManager.Contracts.Repository
{
    public interface IPaymentRequestRepository
    {
        ...
        Task<(int, IList<PaymentRequestDto>)> GetPaymentRequestsOtherPro(PaymentRequestReqPagedDto model, string UserId);
        Task<(int, IList<PaymentRequestAndMemberDto>)> GetPaymentRequestsPM(PaymentRequestReqPagedDto model);
        ...
        Task<(int, int)> UpdatePendingPaymentRequest(UpdatePaymentRequestDto model, string userId, List<string> itemIdsToDelete);
        Task<(int, int)> UpdatePaymentRequestPm(UpdateGroupPaymentRequestPmDto model, string userId, List<string> itemIdsToDelete);
        ...
        Task<(int, int)> DeletePaymentRequestPM(string projId, string paymentRequestId, string userId);
